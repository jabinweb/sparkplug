...
const GlobalCTA = ({ siteContent }: GlobalCTAProps) => {
  const cta = siteContent?.cta || siteContent?.site?.cta;
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="text-white/90">
            <p className="text-base mb-4 font-medium">Trusted by teams at EY, DP World, Meta, Honeywell, Adani & more</p>
            <div className="flex justify-center items-center gap-6 md:gap-10 text-sm flex-wrap">
              <div className="flex items-center gap-2">
                <span className="text-lg">⚡</span>
                <span className="font-semibold text-white">200+ Events Delivered</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-lg">🎯</span>
