      ...
      <div className="bg-[var(--color-bg-primary)] p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border-0 h-full">
        <div className="flex items-start gap-4 mb-4">
          <motion.div 
            ...
            whileHover={{ rotate: 5 }}
          >
            <span className="text-[var(--color-button-text)] text-xl font-bold">{index + 1}</span>
          </motion.div>
          <div>
    ...
    >
      <div className={`${isVision ? 'bg-gradient-to-br from-[var(--color-brand-primary)]/5 to-[var(--color-brand-accent)]/20' : 'bg-gradient-to-br from-[var(--color-brand-secondary)]/5 to-[var(--color-brand-accent)]/20'} p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border-0 h-full`}>
        <div className="flex items-center justify-center mb-6">
          ...
          >
            {isVision ? (
              <svg className="w-8 h-8 text-[var(--color-button-text)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
