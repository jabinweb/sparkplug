    ...
    <div className="bg-[var(--color-bg-primary)]">
      ...
      <section className="py-20 bg-[var(--color-bg-primary)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <div className="inline-flex items-center px-4 py-2 bg-[var(--color-brand-accent)]/20 text-[var(--color-brand-secondary)] rounded-full text-sm font-medium mb-6">
              ...
              <p className="text-[var(--color-text-secondary)] font-medium mb-6">
                <span className="text-[var(--color-brand-primary)]">Perfect for:</span> Off-sites, annual meets, R&Rs, launch events, and culture days.
              </p>
              <div className="mb-8">
                ...
                <ul className="grid grid-cols-2 gap-3">
                  {['Energising burnout teams', 'Breaking silos', 'Boosting morale', 'Making events unforgettable'].map((item, index) => (
                    <li key={index} className="flex items-center text-[var(--color-text-secondary)]">
                      <svg className="w-5 h-5 text-[var(--color-brand-accent)] mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[var(--color-brand-accent)]/20 to-[var(--color-brand-secondary)]/20 rounded-3xl p-8 h-80 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 bg-gradient-to-br from-[var(--color-brand-accent)] to-[var(--color-brand-secondary)] rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl">
                    <span className="text-5xl">🥁</span>
                  </div>
                  <p className="text-[var(--color-text-secondary)] italic">&quot;Everyone becomes part of the same beat&quot;</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="order-2 lg:order-1 relative">
              <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-3xl p-8 h-80 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[var(--color-text-secondary)] italic">&quot;Without the awkward icebreakers&quot;</p>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <p className="text-[var(--color-text-secondary)] font-medium mb-6">
                <span className="text-[var(--color-brand-primary)]">Great for:</span> Onboarding, leadership development, and cross-functional collaboration.
              </p>
              <div className="mb-8">
                <p className="font-bold text-[var(--color-text-primary)] mb-4">Ideal for:</p>
                <ul className="grid grid-cols-2 gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              ...
              <div className="mb-8">
                <p className="font-bold text-[var(--color-text-primary)] mb-4">Modules include:</p>
                <ul className="grid grid-cols-2 gap-3">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-3xl p-8 h-80 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[var(--color-text-secondary)] italic">&quot;Build a culture of belonging&quot;</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="order-2 lg:order-1 relative">
              <div className="bg-gradient-to-br from-pink-100 to-red-100 rounded-3xl p-8 h-80 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[var(--color-text-secondary)] italic">&quot;Fun, memorable experiences&quot;</p>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
