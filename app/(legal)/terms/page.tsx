        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              ...
              {/* Acceptable Use */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">3. Acceptable Use Policy</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              {/* User Accounts */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">4. User Accounts</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">5. Intellectual Property Rights</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mb-3">5.1 Our Content</h3>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-[var(--color-text-primary)] mb-3">5.2 User Content</h3>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* Privacy Policy */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">6. Privacy Policy</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">7. Bookings and Payments</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">8. Team-Building Programs and Services</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              {/* Disclaimers */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">9. Disclaimers</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              {/* Governing Law */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">13. Governing Law</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* Changes to Terms */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">14. Changes to Terms</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* Severability */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">15. Severability</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* Contact Information */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">16. Contact Information</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
