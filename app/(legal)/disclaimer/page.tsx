  ...
  return (
    <div className="bg-[var(--color-bg-primary)]">
      ...
      <PageHero
        ...
        title="Disclaimer"
        subtitle="Sparkplug"
        description="Important information about our services, team building experiences, and limitations of liability."
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              {/* General Disclaimer */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">1. General Disclaimer</h2>
              ...
              {/* Service Content */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">2. Team Building & Events Disclaimer</h2>
              ...
              {/* Professional Advice */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">3. Professional Advice Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* External Links */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">4. External Links Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              {/* Research and Data */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">5. Activity Customization Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">6. Technology and Website Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">7. Financial and Donation Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">8. Partnership and Collaboration Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* Accessibility */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">9. Accessibility Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">10. Translation and Language Disclaimer</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              {/* Changes and Updates */}
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">11. Changes and Updates</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4">12. Contact for Clarifications</h2>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
                  If you have questions about this disclaimer or need clarification on any aspect 
                  of our services, please reach us via our{' '}
                  <Link
                    href="/contact"
